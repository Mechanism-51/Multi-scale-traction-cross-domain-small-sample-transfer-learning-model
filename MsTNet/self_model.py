...
class MMF_T(nn.Module):
	def __init__(self, channels, m):
		...
		self.tfcm_t_1 = TFCM_T(channels,m)
		self.tfcm_t_2 = TFCM_T(channels*2,m)
		self.tfcm_t_3 = TFCM_T(channels*4,m) 
...
class MMF_F(nn.Module):
	def __init__(self, channels, m):
		super().__init__()
		self.conv = Conv(channels)
		self.tfcm_f_1 = TFCM_T(channels,m)
		self.tfcm_f_2 = TFCM_T(channels*2,m)
		self.tfcm_f_3 = TFCM_T(channels*4,m)                                                    
