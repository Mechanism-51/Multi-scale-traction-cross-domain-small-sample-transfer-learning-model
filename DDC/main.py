...
def main():
    ...
    for epoch in trange(EPOCHS):
        ...
        optimizer = torch.optim.SGD([
            ...
            {"params": model.bottleneck.parameters(), "lr": cur_lr},
        ...
        print("[EPOCH] {}: Classification loss: {:.6f}, DDC loss: {:.6f}, Total loss: {:.6f}".format(
            epoch + 1,
            sum(r['classification_loss'] / r['total_steps'] for r in result_train),
            sum(r['ddc_loss'] / r['total_steps'] for r in result_train),
